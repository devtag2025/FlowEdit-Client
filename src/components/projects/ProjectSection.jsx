...
import { Play, Paperclip, ArrowLeft, MoveRight } from "lucide-react";
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button
                  variant="ghost"
                  size="lg"
                  className="text-primary border border-primary text-base rounded-xl py-6 gap-2 cursor-pointer"
                >
                  Revise
                </Button>
                <Button
                  variant="ghost"
                  size="lg"
                  className="text-white text-base bg-primary py-6 rounded-xl gap-2 cursor-pointer"
                >
                  Approve
                </Button>
              </div>
